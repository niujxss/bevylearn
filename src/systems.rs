...
pub fn collision_effect_system(mut commands : Commands , 
...
//生命值检测
pub fn check_health(query : Query<(Entity , &Health )> , mut commands : Commands ) {
...
//碰撞检测
pub fn check_collisions(mut tank_query : Query<(&Transform , &CollisionDamage , &mut Health ) , With<Tank>>,
...
pub fn move_tank(keyboard_input : Res< ButtonInput<KeyCode> >, mut query : Query< &mut Transform, With<Tank> >  ) {
